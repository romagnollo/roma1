...
class Tm_GoogleMap_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	{
		return $configArray = unserialize(Mage::getStoreConfig(self::XML_PATH_EMBED_MARKER, $this->getStore() ));
	}

	public function configContactsMarker()
	{
		return $configArray = unserialize(Mage::getStoreConfig(self::XML_PATH_CONTACTS_MARKER, $this->getStore() ));
	}
	...
	public function getConfig($xml_path)
	{
		...
		return Mage::getStoreConfig($xml_path, $this->getStore());
	}
}