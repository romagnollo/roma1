...
class Mirasvit_SearchSphinx_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'general_search_engine' => 'The engine which is used to search; for <b>external mode (another server)</b> setup indexation manually, follow our manual for more information',
