...
class Mirasvit_SearchSphinx_Helper_Query extends Mage_Core_Helper_Abstract
{
     ...
     *
     * @param string $originalQuery      - user search query
    ...
    protected function _addWord(&$to, $words, $wildcard = null)
    {
        ...
        foreach ($words as $word) {
            ...
            if ($wildcard == Mirasvit_SearchSphinx_Model_Config::WILDCARD_DISABLED || $match === true) {
                $word = ' '.$word.' ';
            } elseif ($wildcard == Mirasvit_SearchSphinx_Model_Config::WILDCARD_PREFIX) {
                $word = $word.' ';
