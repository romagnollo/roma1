...
class Mirasvit_SearchSphinx_Helper_Validator extends Mirasvit_MstCore_Helper_Validator_Abstract
{
    ...
    public function testBlockCatalogSearchLayerExists()
    {
        ...
        if (false === array_search('catalogsearch/layer', $container)) {
            $result = self::INFO;
            $description = 'The block "catalogsearch/layer" does not exist. Layered navigation can be missing on search results page.';
        }
    ...
    public function testMirasvitSearchSphinxCrc()
    {
        $modules = array('SearchSphinx');
