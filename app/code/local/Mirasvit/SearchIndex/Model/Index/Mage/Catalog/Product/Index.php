...
class Mirasvit_SearchIndex_Model_Index_Mage_Catalog_Product_Index extends Mirasvit_SearchIndex_Model_Index
{
    ...
    public function getAvailableAttributes()
    {
        ...
        $result['tags'] = Mage::helper('searchindex')->__('Tags');
        $result['category_name'] = Mage::helper('searchindex')->__('Category');
        $result['category_description'] = Mage::helper('searchindex')->__('Category Description');
        $result['category_meta_title'] = Mage::helper('searchindex')->__('Category Meta Title');
        $result['category_meta_keywords'] = Mage::helper('searchindex')->__('Category Meta Keywords');
        $result['category_meta_description'] = Mage::helper('searchindex')->__('Category Meta Description');
