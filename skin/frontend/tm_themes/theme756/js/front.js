...
$j(document).ready(function() {
    ...
    $j('.header-button, .switch-show').not('.top-login').on("click", function(e) {
        ...
        if (ul.is(':hidden'))
            ul.slideDown(), $j(this).addClass('active')
        else
            ul.slideUp(), $j(this).removeClass('active')
    ...
    jQuery(document).ready(function() {
        jQuery(".parallax").cherryFixedParallax({
            invert: false,
        });
    });

    //$j('body').find('.products-grid .wrapper-hover').prepend('<div class="line-1"><i></i></div><div class="line-2"><i></i></div><div class="line-3"><i></i></div><div class="line-4"><i></i></div>');


    /*****************/
    /****************SEARCH********************
    jQuery('.top-search').on("click", function(){
            if ( $j('#search_mini_form').css('display') == 'none' ) {
            $j('#search_mini_form').animate({width: 'show'}, 200);
            jQuery('.top-search').addClass('active');
            } else {
            $j('#search_mini_form').animate({width: 'hide'}, 200);
        ...
        jQuery(document).on("click touchstart", function(){
            ...
            jQuery('#search_mini_form').on("click touchstart", function(event){
